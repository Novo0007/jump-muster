...
function giveIntroduction () {
    ...
    showInstruction("\" Modify by NNC (BlackCat)\"")
    showInstruction("Enjoy ")
}
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`tile1`, function (sprite, location) {
    ...
    currentLevel += 1
    if (hasNextLevel()) {
        game.splash("Next level unlocked! Whoa", "oouu")
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Flier, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    sprite.say("Ooouch!", invincibilityPeriod * 1.5)
    music.powerDown.play()
...
scene.setBackgroundImage(img`
    ...
    
